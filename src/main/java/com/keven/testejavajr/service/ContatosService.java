...
public class ContatosService {
	...
	public Page<DContatos> findPage(Integer page, Integer linesPerPage, String orderBy, String direction) {
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		return contatosRepository.findAll(pageRequest).map(mapper::entityToDto);
	}
}
